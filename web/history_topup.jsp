...
//            dom: 'Bfrtip',
            "ajax": {
                "url": "/matajari_monitoring/TopupagentServlet?action=Listtopupagent",
                "dataSrc": ""
            },
            "columns": [
                {data: "topup_date"},
                ...
                {data: "process_exe",
                    render: function (data) {
                        if (data == 't') {
                            ...
                            return '<span class="label label-warning">Not Yet Approved</span>'
                        }
                    }
                }
            ],
                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">History Topup ${sessionScope.username_ppob} on MATAJARI</h3>
                                ...
                                <div class="col-md-12">
                                    <table id="tabletopupagent" class="table display table-striped table-bordered responsive-utilities jambo_table" cellspacing="0" width="100%">    
                                        <thead>                                            
                                            ...
                                            <tr class="filters">
                                                <th class="date-filter">Request Date</th>
                                                <th class="date-filter">Approve Date</th>
                                                <th class="input-filter">From Bank</th>
                                                <th class="input-filter">Acct No Mitra</th>
                                                <th class="input-filter">Transfer Date</th>
                                                <th class="input-filter">Amount</th>
                                                <th class="input-filter">Before</th>
                                                <th class="input-filter">After</th>
